        ...
        return (
          <div key={i} className="relative flex flex-1 flex-col items-center gap-1">
            ...
            <div className="flex w-full items-center">
              <span
                style={{ flex: 1, height: 2, background: i === 1 ? 'transparent' : segC(i <= ar) }}
              />
              <span
                ...
                style={{
                  ...
                  boxShadow: isActor
                    ? `0 0 0 3px ${ok ? TONE.secure.tint : TONE.critical.tint}`
                    : 'none',
                }}
              />
              <span
                style={{
                  flex: 1,
                  height: 2,
                  background: i === MAXL ? 'transparent' : segC(i < ar),
                }}
              />
            </div>
            <span
            ...
            {isActor && (
              <span
                ...
                style={{ fontSize: 8, color: ok ? GREEN : RED }}
              >
                actor
              </span>
            )}
...
function DispatchRow({
  ...
  active,
  onClick,
}: { d: S5Dispatch; active: boolean; onClick: () => void }) {
  ...
  return (
    ...
    >
      <span
        ...
        style={{ width: 22, height: 22, background: k.tint, color: k.c }}
      >
        <Glyph size={13} />
      </span>
        ...
        <div className="flex flex-wrap items-start gap-[18px]">
          ...
          <div className="min-w-[280px] flex-1">
            ...
            <div className="text-text-silver" style={{ fontSize: 14.5, maxWidth: 560 }}>
              ...
              <b>monitoring / security discipline rank</b> + standing.{' '}
              <b>Provable, or it doesn’t move.</b>
            </div>
          </div>
        ...
        {d && (
          <div className="flex flex-col gap-4 self-start lg:sticky lg:top-4">
            <DbCard className="p-5">
              <div className="mb-[10px] flex flex-wrap items-center gap-[9px]">
                <span
                  ...
                  style={{
                    ...
                    height: 11,
                    borderRadius: 99,
                    background: d.ok ? GREEN : RED,
                  }}
                />
                <VerdictBadge ok={d.ok}>
                  {d.ok ? 'Rank verified' : 'Rank insufficient'}
                </VerdictBadge>
              ...
              <h2
                className="font-serif font-bold text-text"
                style={{ fontSize: 19, lineHeight: 1.12, margin: '0 0 12px' }}
              >
                {d.action}
              </h2>
              ...
              >
                <div className="mb-[10px] flex items-center gap-[11px]">
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className="font-mono font-bold"
                      style={{ fontSize: 13, color: d.ok ? GREEN : RED }}
                    >
                      {rname(d.disc, d.rr)}
                    </div>
                  </div>
              ...
              >
                ...
                <span className="text-text-silver" style={{ fontSize: 12.5, lineHeight: 1.35 }}>
                  {d.ok ? (
                    <span>
                      <b>Authority proven.</b> {d.actor} holds {rname(d.disc, d.ar)} ({cap(d.disc)}{' '}
                      L{d.ar}) ≥ required {rname(d.disc, d.rr)}, standing in good order. Signed and
                      hash-chained.
                    </span>
                  ) : (
                    <span>
                      ...
                      {d.actor} ({rname(d.disc, d.ar)}) can’t issue a {rname(d.disc, d.rr)}-gated
                      dispatch — standing doesn’t override discipline rank. Held.
                    </span>
                  )}
                </span>
              </div>
