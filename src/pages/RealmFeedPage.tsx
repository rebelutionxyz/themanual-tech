import { REALM_COLORS, REALM_NAMES } from '@/lib/constants';
import { type FeedSort, type ThreadFeedItem, listThreadFeed } from '@/lib/forumFeed';
    ...
    <div className="h-full overflow-y-auto">
      <div className="safe-pad-x mx-auto max-w-4xl px-4 py-6 md:px-8 md:py-8">
        ...
        <div
          ...
          style={{ fontSize: '11px', color: accent, opacity: 0.75 }}
          data-size="meta"
        >
          Realm
        </div>
          ...
          {SORTS.map((opt) => {
            ...
            return (
              <button
                ...
                style={{
                  fontSize: '12px',
                  ...(active ? { color: accent, background: `${accent}18`, fontWeight: 600 } : {}),
                }}
                data-size="meta"
              >
                {opt.label}
          ...
          {realmName && (
            <div className="mb-1.5 flex flex-wrap items-center gap-1.5">
              <span
                ...
                style={{ fontSize: '10px', color: accent, background: `${accent}15` }}
                data-size="meta"
              >
                {realmName}
              </span>
