  ...
  return (
    <main style={styles.page}>
      ...
      <p style={styles.intro}>
        The Manual’s geographic index is built in part on open datasets. We’re grateful to the
        projects below and credit them here in accordance with their licenses.
      </p>
      ...
      {SOURCES.map((s) => (
        <section key={s.title} style={styles.card}>
          ...
          <div style={styles.metaRow}>
            <a style={styles.link} href={s.href} target="_blank" rel="noopener noreferrer">
              View source ↗
            </a>
            <a
      ...
      <p style={styles.footer}>
        ...
        license. Data has been filtered and restructured for use within The Manual; the original
        creators do not endorse this project or its use of the data.
      </p>
    </main>
  );
}
