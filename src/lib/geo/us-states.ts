// US states + DC. Static — populated only when GeoLensBar's country === 'US'.
// Codes are uppercased USPS two-letter abbreviations.
...
const US_STATE_CODE_SET = new Set(US_STATES.map((s) => s.code));
