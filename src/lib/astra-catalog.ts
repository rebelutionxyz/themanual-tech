...
export const ASTRA_CATALOG: AstraCatalogEntry[] = [
  ...
  { slug: 'crowdfunding',  wordmark: 'Crowdfunding',    category: 'economy', hosts: ['rebelution.ing', 'Fountainheadcafe.com'],                  status: 'scaffolded',                            description: 'Campaign funding via BLiNG! pledges.', route: '/give', mount: 'page', accent: '#16A34A' },
