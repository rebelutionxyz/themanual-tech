...
export function CommunityShell({
  ...
  /* FRONT78: the `bling-hop` dispatch that used to fire here is gone with the
     spine drop it drove (owner: "we dont need the bling drop"). The toggle is
     back to being only a toggle. */
