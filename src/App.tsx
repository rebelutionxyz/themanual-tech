...
const AccountHubPage = lazy(() =>
  import('@/pages/account/AccountHubPage').then((m) => ({ default: m.AccountHubPage })),
);
...
const AstraStubPage = lazy(() =>
  import('@/pages/AstraStubPage').then((m) => ({ default: m.AstraStubPage })),
);
...
const CollectionsIndexPage = lazy(() =>
  import('@/pages/CollectionsIndexPage').then((m) => ({ default: m.CollectionsIndexPage })),
);
import { ComingSoonPage } from '@/pages/ComingSoonPage';
const HandleSettingsPage = lazy(() =>
  import('@/pages/HandleSettingsPage').then((m) => ({ default: m.HandleSettingsPage })),
);
const PatchboardSettingsPage = lazy(() =>
  import('@/pages/PatchboardSettingsPage').then((m) => ({ default: m.PatchboardSettingsPage })),
);
...
const NucleusPage = lazy(() =>
  import('@/pages/NucleusPage').then((m) => ({ default: m.NucleusPage })),
);
...
const RealmFeedPage = lazy(() =>
  import('@/pages/RealmFeedPage').then((m) => ({ default: m.RealmFeedPage })),
);
...
const SurfacePage = lazy(() =>
  import('@/pages/SurfacePage').then((m) => ({ default: m.SurfacePage })),
);
const WavesPage = lazy(() => import('@/pages/WavesPage').then((m) => ({ default: m.WavesPage })));
const BazaarBrowse = lazy(() =>
  import('@/pages/bazaar/BazaarBrowse').then((m) => ({ default: m.BazaarBrowse })),
);
const BazaarListingDetail = lazy(() =>
  import('@/pages/bazaar/BazaarListingDetail').then((m) => ({ default: m.BazaarListingDetail })),
);
const BazaarNew = lazy(() =>
  import('@/pages/bazaar/BazaarNew').then((m) => ({ default: m.BazaarNew })),
);
const BazaarOrders = lazy(() =>
  import('@/pages/bazaar/BazaarOrders').then((m) => ({ default: m.BazaarOrders })),
);
const CommsPage = lazy(() =>
  import('@/pages/comms/CommsPage').then((m) => ({ default: m.CommsPage })),
);
const CommunityLayout = lazy(() =>
  import('@/pages/community/CommunityLayout').then((m) => ({ default: m.CommunityLayout })),
);
const AtlasOraclePage = lazy(() =>
  import('@/pages/dingleberry/AtlasOraclePage').then((m) => ({ default: m.AtlasOraclePage })),
);
const CommandCenterPage = lazy(() =>
  import('@/pages/dingleberry/CommandCenterPage').then((m) => ({ default: m.CommandCenterPage })),
);
const DingleberryLayout = lazy(() =>
  import('@/pages/dingleberry/DingleberryLayout').then((m) => ({ default: m.DingleberryLayout })),
);
const DispatchAuthPage = lazy(() =>
  import('@/pages/dingleberry/DispatchAuthPage').then((m) => ({ default: m.DispatchAuthPage })),
);
const GoDarkMonitorPage = lazy(() =>
  import('@/pages/dingleberry/GoDarkMonitorPage').then((m) => ({ default: m.GoDarkMonitorPage })),
);
const InfraHealthPage = lazy(() =>
  import('@/pages/dingleberry/InfraHealthPage').then((m) => ({ default: m.InfraHealthPage })),
);
const JusticeHandoffPage = lazy(() =>
  import('@/pages/dingleberry/JusticeHandoffPage').then((m) => ({ default: m.JusticeHandoffPage })),
);
const KarmaCreditPage = lazy(() =>
  import('@/pages/dingleberry/KarmaCreditPage').then((m) => ({ default: m.KarmaCreditPage })),
);
const MemberMeshPage = lazy(() =>
  import('@/pages/dingleberry/MemberMeshPage').then((m) => ({ default: m.MemberMeshPage })),
);
const PostureBoardPage = lazy(() =>
  import('@/pages/dingleberry/PostureBoardPage').then((m) => ({ default: m.PostureBoardPage })),
);
const ShillDetectionPage = lazy(() =>
  import('@/pages/dingleberry/ShillDetectionPage').then((m) => ({ default: m.ShillDetectionPage })),
);
const SourceVerificationPage = lazy(() =>
  import('@/pages/dingleberry/SourceVerificationPage').then((m) => ({
    default: m.SourceVerificationPage,
  })),
);
const ThreatInterceptionPage = lazy(() =>
  import('@/pages/dingleberry/ThreatInterceptionPage').then((m) => ({
    default: m.ThreatInterceptionPage,
  })),
);
const TransactionSecurityPage = lazy(() =>
  import('@/pages/dingleberry/TransactionSecurityPage').then((m) => ({
    default: m.TransactionSecurityPage,
  })),
);
...
const BalancePage = lazy(() =>
  import('@/pages/freedomblings/BalancePage').then((m) => ({ default: m.BalancePage })),
);
const CharterPage = lazy(() =>
  import('@/pages/freedomblings/CharterPage').then((m) => ({ default: m.CharterPage })),
);
const CirculationPage = lazy(() =>
  import('@/pages/freedomblings/CirculationPage').then((m) => ({ default: m.CirculationPage })),
);
const EarningPage = lazy(() =>
  import('@/pages/freedomblings/EarningPage').then((m) => ({ default: m.EarningPage })),
);
...
const FreedomblingsLayout = lazy(() =>
  import('@/pages/freedomblings/FreedomblingsLayout').then((m) => ({
    default: m.FreedomblingsLayout,
  })),
);
const GradationsPage = lazy(() =>
  import('@/pages/freedomblings/GradationsPage').then((m) => ({ default: m.GradationsPage })),
);
const LedgerPage = lazy(() =>
  import('@/pages/freedomblings/LedgerPage').then((m) => ({ default: m.LedgerPage })),
);
const LineagePage = lazy(() =>
  import('@/pages/freedomblings/LineagePage').then((m) => ({ default: m.LineagePage })),
);
const MovePage = lazy(() =>
  import('@/pages/freedomblings/MovePage').then((m) => ({ default: m.MovePage })),
);
const OpenBooksPage = lazy(() =>
  import('@/pages/freedomblings/OpenBooksPage').then((m) => ({ default: m.OpenBooksPage })),
);
const StandingPage = lazy(() =>
  import('@/pages/freedomblings/StandingPage').then((m) => ({ default: m.StandingPage })),
);
const CampaignPage = lazy(() =>
  import('@/pages/give/CampaignPage').then((m) => ({ default: m.CampaignPage })),
);
const GivePage = lazy(() => import('@/pages/give/GivePage').then((m) => ({ default: m.GivePage })));
const GroupPage = lazy(() =>
  import('@/pages/groups/GroupPage').then((m) => ({ default: m.GroupPage })),
);
const GroupsPage = lazy(() =>
  import('@/pages/groups/GroupsPage').then((m) => ({ default: m.GroupsPage })),
);
const IntelPage = lazy(() =>
  import('@/pages/intel/IntelPage').then((m) => ({ default: m.IntelPage })),
);
const NewThreadPage = lazy(() =>
  import('@/pages/intel/NewThreadPage').then((m) => ({ default: m.NewThreadPage })),
);
const ReportedPage = lazy(() =>
  import('@/pages/intel/ReportedPage').then((m) => ({ default: m.ReportedPage })),
);
const ThreadPage = lazy(() =>
  import('@/pages/intel/ThreadPage').then((m) => ({ default: m.ThreadPage })),
);
...
const OraclePage = lazy(() =>
  import('@/pages/oracle/OraclePage').then((m) => ({ default: m.OraclePage })),
);
...
const ChannelPage = lazy(() =>
  import('@/pages/pulse/ChannelPage').then((m) => ({ default: m.ChannelPage })),
);
const PulseHome = lazy(() =>
  import('@/pages/pulse/PulseHome').then((m) => ({ default: m.PulseHome })),
);
const WatchPage = lazy(() =>
  import('@/pages/pulse/WatchPage').then((m) => ({ default: m.WatchPage })),
);
const NovaPage = lazy(() => import('@/pages/nova/NovaPage').then((m) => ({ default: m.NovaPage })));
const BrandosophicLayout = lazy(() =>
  import('@/pages/brandosophic/BrandosophicLayout').then((m) => ({
    default: m.BrandosophicLayout,
  })),
);
const BrandosophicStudioPage = lazy(() =>
  import('@/pages/brandosophic/BrandosophicStudioPage').then((m) => ({
    default: m.BrandosophicStudioPage,
  })),
);
const BrandosophicBrandsPage = lazy(() =>
  import('@/pages/brandosophic/BrandosophicBrandsPage').then((m) => ({
    default: m.BrandosophicBrandsPage,
  })),
);
const BrandosophicNovasPage = lazy(() =>
  import('@/pages/brandosophic/BrandosophicNovasPage').then((m) => ({
    default: m.BrandosophicNovasPage,
  })),
);
const BrandosophicStorefrontPage = lazy(() =>
  import('@/pages/brandosophic/BrandosophicStorefrontPage').then((m) => ({
    default: m.BrandosophicStorefrontPage,
  })),
);
...
const ImageEditorPage = lazy(() =>
  import('@/pages/studio/ImageEditorPage').then((m) => ({ default: m.ImageEditorPage })),
);
const ResponseRecorderPage = lazy(() =>
  import('@/pages/studio/ResponseRecorderPage').then((m) => ({ default: m.ResponseRecorderPage })),
);
const VideoEditorPage = lazy(() =>
  import('@/pages/studio/VideoEditorPage').then((m) => ({ default: m.VideoEditorPage })),
);
