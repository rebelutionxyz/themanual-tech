...
-- Ratified + applied to prod 2026-07-16 (Intel menu completion session).
-- ═══════════════════════════════════════════════════════════════════════
...
comment on column public.ui_theme_config.branding is
  'HQ-editable brand config: {wordmarkPre, wordmarkAccent, wordmarkPost, wordmarkSuffix, accentHex, logoUrl, faviconUrl}. Baked defaults in src/lib/branding.ts win for any missing key. ui_branding_v1 2026-07-16.';
