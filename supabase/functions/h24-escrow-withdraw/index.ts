// POST /functions/v1/h24-escrow-withdraw
...
//
// Wraps public.h24_withdraw_from_escrow(numeric). The RPC uses
...
Deno.serve(async (req) => {
  ...
  const { data, error } = await sb.rpc('h24_withdraw_from_escrow', {
    p_amount: amount,
  });
  ...
  if (error) {
    ...
    console.error('h24-escrow-withdraw error', {
  ...
  console.log('h24-escrow-withdraw ok', {
