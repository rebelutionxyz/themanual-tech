/* DingleBERRY — Icons (Lucide path data, MIT). Extends the JUSTICE set
   with monitoring glyphs. Stroke style, 24px grid. Sets window.TLWIcon. */

const DB_ICONS = {
  /* carried from JUSTICE */
  ...
  sparkle: '<path d="M9.94 14.32a1 1 0 0 0-.84-.61l-6.6-.96a.5.5 0 0 1-.28-.86l4.78-4.66a1 1 0 0 0 .29-.89L6.16.99a.5.5 0 0 1 .72-.53l5.91 3.1a1 1 0 0 0 .94 0l5.9-3.1a.5.5 0 0 1 .73.53"/>',
  gitBranch: '<line x1="6" x2="6" y1="3" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>',
};

function DBIcon({ name, size = 18, stroke = 2, fill = 'none', className = '', style }) {
  const inner = DB_ICONS[name] || '';
  return (
...
window.TLWIcon = DBIcon;
window.DB_ICONS = DB_ICONS;
